...
**Outcome Definition:** High-risk status defined using the 90th percentile threshold of outstanding debt ($205.30) among patients with non-zero balances, capturing the top 10% of debtors. Additionally includes patients with payment ratio <1% and non-zero outstanding balance (2.1% prevalence, n=36/1,701 patients).
...
└── reports/
    ...
    └── ftr_analysis_report.pdf       # Complete research report
```
